...
To check the tests of example smart contracts
```
nix develop
cabal build all
cabal run cardano-node-emulator-test
```

The rest of this README is as seen on the original repo I forked from
